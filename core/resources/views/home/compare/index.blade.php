                        ...
                        <table class="table table-bordered mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-image-title">
                                        <a href="single-product.html" class="image">
                                            <img style="width: 200px" class="img-fluid" src="{{ asset(env('PRODUCT_IMAGES_UPLOAD_PATH') . $product->primary_image) }}"
                                                alt="Compare Product">
                                        </a>
                                ...
                                <tr>
                                    ...
                                    @foreach ($products as $product)
                                        <td class="pro-remove">
                                            <a href="{{ route('home.compare.remove' , ['product' => $product->id]) }}"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    @endforeach
