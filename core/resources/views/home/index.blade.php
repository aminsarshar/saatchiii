                ...
                <div class="swiper" id="homeSlider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <a href=""><img src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH') . $slider->image )}}" class="d-sm-block d-none" alt=""></a>
                            <a href=""><img src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH') . $slider->image )}}" class="d-sm-none d-block" alt=""></a>
                        </div>
                        @endforeach
            ...
            <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide ml-0">
                    <div class="d-flex justify-content-center align-items-center flex-column" style="margin-top:63px ">
                        ...
                        <a href="{{route('home.special-offer')}}" class="mt-2 text-white">مشاهده همه <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="product-box-item bg-white" style="height: 388px">
                        <div class="hover">
                            <div class="hover-btn">
                                ...
                                <a href="{{route('home.compare.add' , ['product' => $products_special_offer])}}" data-hint="مقایسه محصول" class="hint--right"><i
                                class="bi bi-arrow-left-right"></i></a>

                                @auth
                                @if ($products_special_offer->checkUserWishlist(auth()->id()))
                                <a href="{{route('home.wishlist.remove' , ['product' => $products_special_offer->id])}}" data-hint="افزوده شده" class="hint--right" style="background: red"><i
                                        class="bi bi-heart"></i></a>
                                @else
                                <a href="{{route('home.wishlist.add' , ['product' => $products_special_offer->id])}}" data-hint="افزودن به علاقه مندی" class="hint--right"><i
                                class="bi bi-heart"></i></a>
                                @endif
                                ...
                                <a href="#productModal-{{$products_special_offer->id}}" data-hint="مشاهده سریع" class="hint--right"
                                    data-bs-toggle="modal" data-bs-target="#productModal-{{$products_special_offer->id}}"><i
                                        class="bi bi-eye"></i></a>
                            </div>
                        ...
                        <a href="{{ route('home.products.show' , ['product' => $products_special_offer->slug]) }}">
                            <div class="image text-center">
                                ...
                                <img src="{{asset('/core/public/upload/files/products/images/' . $products_special_offer->primary_image )}}" alt="توضیحات عکس" class="img-fluid one-image">
                                {{-- hover image --}}
                            ...
                            <div class="desc">
                                ...
                                <div class="foot d-flex justify-content-between align-items-center">
                                    ...
                                    <input type="hidden" name="product_id" value="{{ $products_special_offer->id }}">
                                    @csrf
                                    ...
                                    <form action="{{ route('home.cart.add') }}" method="POST">
                                        ...
                                        @if($products_special_offer->quantity_check)
                                            ...
                                            <div class="pro-details-size-color text-right">
                                                <div class="pro-details-size w-50" style="display: none">
                                                    <span>{{ App\Models\Attribute::find($products_special_offer->variations->first()->attribute_id)->name }}</span>
                                                    <select  name="variation" class="form-control variation-select" data-id="{{$products_special_offer->id}}" style="    width: 160px;">
                                                        @foreach ($products_special_offer->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                            <option
                                                            value="{{ json_encode($variation->only(['id' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}"
                                                            {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
                                            ...
                                            <div class="pro-details-quality">
                                                ...
                                                <div class="pro-details-wishlist" style="display: none">
                                                    @auth
                                                        @if ($products_special_offer->checkUserWishlist(auth()->id()))
                                                            <a href="{{ route('home.wishlist.remove' , ['product' => $products_special_offer->id]) }}"><i class="fas fa-heart" style="color:red"></i>
                                                            </a>
                                                        @else
                                                            <a href="{{ route('home.wishlist.add' , ['product' => $products_special_offer->id]) }}"><i class="sli sli-heart"></i>
                                                            </a>
                                                        @endif
                                ...
                                <div class="timer text-center mt-2">
                                    <div class='countdown' data-date="{{$products_special_offer->daily_timer}}" data-time="17:30">
                                    </div>
                                </div>
                            </div>
                        </a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 test" data-aos="fade-left"  data-aos-duration="700" style="padding-left: 30px;">
                <div
                    class="d-flex justify-content-between align-items-center shadow-box bg-white prodcut-banner-item">
                    <div class="desc">
                        <div class="title-1">
                    ...
                    <div class="swiper-slide wow animate__animated animate__fadeInRight" style="">
                        <div class="product-box-item bg-white">
                            ...
                            <a href="{{ route('home.products.show' , ['product' => $product_normal_men->slug]) }}">
                                <div class="image text-center">
                                    <img src="{{asset('/core/public/upload/files/products/images/' . $product_normal_men->primary_image )}}" alt="" class="img-fluid one-image">
                                    {{-- hover image --}}
    ...
    <div class="container-fluid" style="overflow: hidden !important">
        <div class="row">
            ...
            <div class="col-md-3 col-6 mt-md-0 mt-2" data-aos="fade-up" data-aos-duration="700">
                <a href="">
                    <img src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH') . $banner->image )}}" class="img-fluid rounded-3 shadow-box" alt="" >
                </a>
            </div>
            @endforeach
            ...
            <div class="row">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="sugget-item">
                                    ...
                                    <div class="image">
                                        <a href="{{ route('home.products.show' , ['product' => $product_daily_offer->slug]) }}">
                                            <img src="{{asset('/core/public/upload/files/products/images/' . $product_daily_offer->primary_image )}}" alt="" class="img-fluid">
                                        </a>


                                    </div>
                                    <div class="title">
                                        <h6 class="fw-bold font-14"><a href="{{ route('home.products.show' , ['product' => $product_daily_offer->slug]) }}">{{$product_daily_offer->name}}</a></h6>
                                    </div>
                                    <div class="foot d-flex justify-content-between align-items-center">
                                        <div class="foot d-flex justify-content-between align-items-center">
                                            <form action="{{ route('home.cart.add') }}" method="POST">
                                            <input type="hidden" name="product_id" value="{{ $product_daily_offer->id }}">
                                            @csrf
                                            @if($product_daily_offer->quantity_check)
                                                @php
                                                    if($product_daily_offer->sale_check)
                                                    {
                                                        $variationProductSelected = $product_daily_offer->sale_check;
                                                    }else{
                                                        $variationProductSelected = $product_daily_offer->price_check;
                                                    }
                                                @endphp
                                                <div class="pro-details-size-color text-right">
                                                    <div class="pro-details-size w-50" style="display: none">
                                            ...
                                            <form action="{{ route('home.cart.add') }}" method="POST">
                                                ...
                                                @if($product_daily_offer->quantity_check)
                                                    ...
                                                    <div class="pro-details-size-color text-right">
                                                        <div class="pro-details-size w-50" style="display: none">
                                                            <span>{{ App\Models\Attribute::find($product_daily_offer->variations->first()->attribute_id)->name }}</span>
                                                            <select  name="variation" class="form-control variation-select" data-id="{{$product_daily_offer->id}}" style="    width: 160px;">
                                                                @foreach ($product_daily_offer->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                                    <option
                                                                    value="{{ json_encode($variation->only(['id' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}"
                                                                    {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
                                                        ...
                                                        <div class="pro-details-wishlist" style="display: none">
                                                            @auth
                                                                @if ($product_daily_offer->checkUserWishlist(auth()->id()))
                                                                    <a href="{{ route('home.wishlist.remove' , ['product' => $product_daily_offer->id]) }}"><i class="fas fa-heart" style="color:red"></i>
                                                                    </a>
                                                                @else
                                                                    <a href="{{ route('home.wishlist.add' , ['product' => $product_daily_offer->id]) }}"><i class="sli sli-heart"></i>
                                                                    </a>
                                                                @endif
                ...
                <div class="col-lg-9 order-1">
                    <div class="parent">
                        ...
                        <div class="row">
                            @foreach ($product_daily_offers as $product_daily_offer)
                            <div class="col-lg-4 col-sm-6 wow animate__animated animate__slideInUp" data-wow-offset="100" data-wow-duration="1.5s" style="overflow: hidden !important">
                                <a href="{{ route('home.products.show' , ['product' => $product_daily_offer->slug]) }}">
                                    <div
                                        class="product-row bg-white d-flex align-items-center justify-content-between rounded-4 shadow-md">
                                        <div class="image">
                                            <img src="{{asset('/core/public/upload/files/products/images/' . $product_daily_offer->primary_image )}}" class="img-fluid"
                                                width="100" alt="">
                                        </div>
                                        <div class="desc">
                                            <h6 class="font-14 title text-overflow">{{$product_daily_offer->name}}</h6>
                        ...
                        <div class="product-box-item bg-white">
                            <div class="hover">
                                <div class="hover-btn">
                                    ...
                                    <a href="{{route('home.compare.add' , ['product' => $product_normal_women])}}" data-hint="مقایسه محصول" class="hint--right"><i
                                    class="bi bi-arrow-left-right"></i></a>

                                    @auth
                                    @if ($product_normal_women->checkUserWishlist(auth()->id()))
                                    <a href="{{route('home.wishlist.remove' , ['product' => $product_normal_women->id])}}" data-hint="افزوده شده" class="hint--right" style="background: red"><i
                                            class="bi bi-heart"></i></a>
                                    @else
                                    <a href="{{route('home.wishlist.add' , ['product' => $product_normal_women->id])}}" data-hint="افزودن به علاقه مندی" class="hint--right"><i
                                    class="bi bi-heart"></i></a>
                                    @endif
                                    ...
                                    <a href="#productModal-{{$product_normal_women->id}}" data-hint="مشاهده سریع" class="hint--right"
                                        data-bs-toggle="modal" data-bs-target="#productModal-{{$product_normal_women->id}}"><i
                                            class="bi bi-eye"></i></a>
                                </div>
                                <div class="hover-color">
                                    <span style="background-color: #10b663;" data-hint="رنگ سبز"
                            ...
                            <a href="{{ route('home.products.show' , ['product' => $product_normal_women->slug]) }}">
                                <div class="image text-center">
                                    <img src="{{asset('/core/public/upload/files/products/images/' . $product_normal_women->primary_image )}}" alt="" class="img-fluid one-image">
                                    {{-- hover image --}}
                                ...
                                <div class="desc">
                                    ...
                                    <div class="foot d-flex justify-content-between align-items-center">
                                        <form action="{{ route('home.cart.add') }}" method="POST">
                                        <input type="hidden" name="product_id" value="{{ $product_normal_women->id }}">
                                        @csrf
                                        ...
                                        <form action="{{ route('home.cart.add') }}" method="POST">
                                            ...
                                            @if($product_normal_women->quantity_check)
                                                ...
                                                <div class="pro-details-size-color text-right">
                                                    <div class="pro-details-size w-50" style="display: none">
                                                        <span>{{ App\Models\Attribute::find($product_normal_women->variations->first()->attribute_id)->name }}</span>
                                                        <select  name="variation" class="form-control variation-select" data-id="{{$product_normal_women->id}}" style="    width: 160px;">
                                                            @foreach ($product_normal_women->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                                <option
                                                                value="{{ json_encode($variation->only(['id' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}"
                                                                {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
                                                ...
                                                <div class="pro-details-quality">
                                                    ...
                                                    <div class="pro-details-wishlist" style="display: none">
                                                        @auth
                                                            @if ($product_normal_women->checkUserWishlist(auth()->id()))
                                                                <a href="{{ route('home.wishlist.remove' , ['product' => $product_normal_women->id]) }}"><i class="fas fa-heart" style="color:red"></i>
                                                                </a>
                                                            @else
                                                                <a href="{{ route('home.wishlist.add' , ['product' => $product_normal_women->id]) }}"><i class="sli sli-heart"></i>
                                                                </a>
                                                            @endif
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 mt-md-0 mt-2">
                <a href="">
                    <img src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH') . $sbanner->image )}}" class="img-fluid rounded-3 shadow-box" alt="">
                </a>
            </div>
          @endforeach
...
<!-- product modal -->
@foreach ($products_special_offers as $products_special_offer)
<div class="modal fade modal-lg product-modal" id="productModal-{{$products_special_offer->id}}" tabindex="-1">
                ...
                <div class="row">
                    <div class="col-md-5 mb-md-0 mb-2">
                        <div class="swiper product-modal">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('/core/public/upload/files/products/images/' . $products_special_offer->primary_image) }}" alt="" class="img-fluid">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('/core/public/upload/files/products/images/' . $products_special_offer->primary_image) }}" alt="" class="img-fluid">
                                </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="variation-price-{{$products_special_offer->id}}" style="color: #6666ff;text-align: right;font-size: 21px;margin: 9px;">
                            @if($products_special_offer->quantity_check)
                            @if($products_special_offer->sale_check)
                            <style>
                                .variation-price{
                                ...
                                @if($products_special_offer->quantity_check)
                                    ...
                                    <div class="pro-details-size-color text-right" style="display: flex">
                                        <div class="pro-details-size w-50">
                                            <span>{{ App\Models\Attribute::find($products_special_offer->variations->first()->attribute_id)->name }}</span>
                                            <select name="variation" class="form-control variation-select" data-id="{{$products_special_offer->id}}">
                                                @foreach ($products_special_offer->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                    <option
                                                    value="{{ json_encode($variation->only(['id' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}"
                                                    {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
                                        ...
                                        <div class="cart-plus-minus" style="text-align: -webkit-right;padding-right:10px">
                                          <span>تعداد</span>
                                          <input style="width: 100px" class="form-control cart-plus-minus-box quantity-input" type="text" name="qtybutton" value="1" data-max="5" />
                                      </div>
...
@foreach ($product_normal_mens as $product_normal_men)
<div class="modal fade modal-lg product-modal" id="productModal-{{$product_normal_men->id}}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">
                ...
                <div class="row">
                    <div class="col-md-5 mb-md-0 mb-2">
                        <div class="swiper product-modal">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('/core/public/upload/files/products/images/' . $product_normal_men->primary_image) }}" alt="" class="img-fluid">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('/core/public/upload/files/products/images/' . $product_normal_men->primary_image) }}" alt="" class="img-fluid">
                                </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="variation-price-{{$product_normal_men->id}}" style="color: #6666ff;text-align: right;font-size: 21px;margin: 9px;">
                            @if($product_normal_men->quantity_check)
                            @if($product_normal_men->sale_check)
                            <style>
                                .variation-price{
                            ...
                            <form action="{{ route('home.cart.add') }}" method="POST">
                                ...
                                @if($product_normal_men->quantity_check)
                                    ...
                                    <div class="pro-details-size-color text-right" style="display: flex">
                                        <div class="pro-details-size w-50">
                                            <span>{{ App\Models\Attribute::find($product_normal_men->variations->first()->attribute_id)->name }}</span>
                                            <select name="variation" class="form-control variation-select" data-id="{{$product_normal_men->id}}">
                                                @foreach ($product_normal_men->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                    <option
                                                    value="{{ json_encode($variation->only(['id' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}"
                                                    {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
...
@foreach ($product_normal_womens as $product_normal_women)
<div class="modal fade modal-lg product-modal" id="productModal-{{$product_normal_women->id}}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">
                ...
                <div class="row">
                    <div class="col-md-5 mb-md-0 mb-2">
                        <div class="swiper product-modal">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('/core/public/upload/files/products/images/' . $product_normal_women->primary_image) }}" alt="" class="img-fluid">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('/core/public/upload/files/products/images/' . $product_normal_women->primary_image) }}" alt="" class="img-fluid">
                                </div>
                    ...
                    <div class="col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <span class="product-meta-item text-muted">
                                        <i class="bi bi-tag"></i>
                                        دسته بندی:
                                        <a href="">{{$product_normal_women->category->parent->name}}</a>,
                        ...
                        <div class="variation-price-{{$product_normal_women->id}}" style="color: #6666ff;text-align: right;font-size: 21px;margin: 9px;">
                            @if($product_normal_women->quantity_check)
                            @if($product_normal_women->sale_check)
                            <style>
                                .variation-price{
                            ...
                            <form action="{{ route('home.cart.add') }}" method="POST">
                                ...
                                @if($product_normal_women->quantity_check)
                                    ...
                                    <div class="pro-details-size-color text-right" style="display: flex">
                                        <div class="pro-details-size w-50">
                                            <span>{{ App\Models\Attribute::find($product_normal_women->variations->first()->attribute_id)->name }}</span>
                                            <select name="variation" class="form-control variation-select" data-id="{{$product_normal_women->id}}">
                                                @foreach ($product_normal_women->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                    <option
                                                    value="{{ json_encode($variation->only(['id' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}"
                                                    {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
