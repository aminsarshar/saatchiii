...
<div class="shop-select">
    <select class="form-control bg-light" id="sort-by" onchange="filter()">
...
<div class="product-box-item bg-white w-100">
    <div class="hover">
        <div class="hover-btn">
            ...
            <a href="#productModal-{{ $product->id }}" data-hint="مشاهده سریع"
        ...
        <div class="image text-center">
            ...
            @foreach ($product->images as $image)
                <img src="{{ asset('/core/public/upload/files/products/images/'.$products_special_offer->primary_image.$image->image) }}"
...
<div class="swiper-wrapper">
    <div class="swiper-slide">
        <img src="{{ asset('/core/public/upload/files/products/images/' . $product->primary_image) }}"
            alt="" class="img-fluid">
    </div>
    <div class="swiper-slide">
        <img src="{{ asset('/core/public/upload/files/products/images/' . $product->primary_image) }}"
...
<div class="variation-price-{{ $product->id }}"
...
@if ($product->quantity_check)
    @if ($product->sale_check)
        ...
        <span class="new">
            ...
            <svg class="mr-2" width="20" height="22" viewBox="0 0 25 27"
        ...
        <div class="pro-details-size-color text-right" style="display: flex">
            ...
            <div class="cart-plus-minus"
                ...
                <input style="width: 90px"
                    class="form-control cart-plus-minus-box quantity-input"
                    type="text" name="qtybutton" value="1" data-max="5" />
            </div>
