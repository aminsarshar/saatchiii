...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <a href="{{ route('admin.comments.change-approve' , ['comment' => $comment->id]) }}" class="btn btn-danger mt-5">عدم تایید و حذف</a>
            @else
            <a href="{{ route('admin.comments.change-approve', ['comment' => $comment->id]) }}" class="btn btn-success mt-5">تایید و نمایش </a>
            @endif
