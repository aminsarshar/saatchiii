                        ...
                        <div class="item-boxs">
                            <div class="item-box bg-white shadow-box">
                                ...
                                <div class="desc collapse show" id="collapseItemBox">
                                    <a href=""
                                        class="btn btn-outline-dark btn-sm rounded-pill border-1 border-muted me-1 font-14 mb-2">
                                        <span>گوشی الجی</span>
                                    ...
                                    <form action="" method="get">
                                        <div class="form-group">
                                            ...
                                            <div class="show-more-btn mt-2 text-center">
                                                <button
                                                    class="btn border-0 main-color-two-bg shadow-box waves-effect waves-light"
                                ...
                                <div class="desc collapse show" id="collapseItemBoxExist">
                                    <form action="">
                                        <div class="form-check">
                                            ...
                                            <input type="checkbox" name="exist" id="existCheck"
                                ...
                                <div class="desc collapse show" id="collapseItemBoxColor">
                                    <form action="">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                            <div class="form-check">
                                                <label for="colorCheck1" class="form-check-label">بنفش</label>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                            <div class="form-check">
                                                <label for="colorCheck5" class="form-check-label">گوجه ای</label>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                            <div class="form-check">
                                                <label for="colorCheck4" class="form-check-label">زرد</label>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                            <div class="form-check">
                                                <label for="colorCheck3" class="form-check-label">سبز</label>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                            <div class="form-check">
                                                <label for="colorCheck2" class="form-check-label">قرمز</label>
                                        ...
                                        <div class="form-group">
                                            <button type="submit"
                                                class="btn border-0 main-color-one-bg mx-auto d-block rounded-pill px-3">
                            ...
                            <div class="item-box bg-white shadow-box">
                                <div class="title">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="btn border-0" data-bs-toggle="collapse"
                                            href="#collapseItemBoxCategory" role="button" aria-expanded="false">
                                            <i class="bi bi-chevron-up"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="desc collapse show" id="collapseItemBoxCategory">
                                    <form action="">
                                        <div class="form-check">
                                            <label for="catCheck1" class="form-check-label">کالادیجیتال</label>
                                            <input type="checkbox" name="" id="catCheck1" class="form-check-input">
                                        </div>
                                        <div class="form-check">
                                            <label for="catCheck2" class="form-check-label">گوشی موبایل</label>
                                            <input type="checkbox" name="" id="catCheck2" class="form-check-input">
                                        </div>
                                        <div class="form-check">
                                            <label for="catCheck3" class="form-check-label">فروش ویژه</label>
                                            <input type="checkbox" name="" id="catCheck3" class="form-check-input">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit"
                                                class="btn border-0 main-color-one-bg mx-auto d-block rounded-pill px-3">
                        ...
                        <div class="item-box bg-white shadow-box">
                            ...
                            <div class="sidebar-style mr-30">
                                ...
                                <div class="sidebar-widget">
                                    <h4 class="pro-sidebar-title"> فیلتر محصولات </h4>
                                   ...
                                   <div class="item-box bg-white shadow-box">
                                        <div class="title">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <a class="btn border-0" data-bs-toggle="collapse" href="#collapseItemBoxColor-{{ $attribute->id }}"
                                                    role="button" aria-expanded="false">
                                                    <i class="bi bi-chevron-up"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="desc collapse show" id="collapseItemBoxColor-{{ $attribute->id }}">
                                            @foreach ($attribute->values as $value)
                                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                    <div class="form-check">
                                                        <label for="colorCheck11" class="form-check-label"> {{ $value->value }}</label>
                                                        {{-- <input type="checkbox" name="" id="colorCheck1" class="form-check-input"> --}}
                                                        <input type="checkbox" class="form-check-input attribute-{{ $attribute->id }}"
                                            ...
                                            @foreach ($variation->variationValues as $value)
                                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                    <div class="form-check">
                                                        ...
                                                        <input type="checkbox" class="form-check-label variation" value="{{ $value->value }}"
                                                        onchange="filter()"
