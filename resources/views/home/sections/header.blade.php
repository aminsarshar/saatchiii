...
<body>
                            ...
                            <div class="header-bottom-btn">
                                <a href="{{ route('home.wishlist.users_profile.index') }}"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                        fill="currentColor" class="bi bi-heart me-2" viewBox="0 0 16 16">
                                        <path
                                ...
                                <a class="header-bottom-link waves-effect waves-light d-flex align-items-center justify-content-center flex-wrap"
                                    ...
                                    @if (!\Cart::isEmpty())
                                        <span
                                            class="count-item rounded-circle">{{ \Cart::getContent()->count() }}</span>
                                    @endif
                            ...
                            <div class="offcanvas offcanvas-start" tabindex="-1" id="responsiveMenu" style="width:75%"
                                ...
                                <div class="offcanvas-body">
                                    ...
                                    <ul class="rm-item-menu navbar-nav">
                                        <li class="nav-item bg-ul-f7"><a href="{{ route('home.index') }}"
                                                class="nav-link">صفحه
                                                اصلی</a>
                                        </li>
                                        @php
                                        ...
                                        @foreach ($parentCategories as $parentCategory)
                                            <li class="nav-item bg-ul-f7">
                                                <a href="{{ route('home.categories.show', ['category' => $parentCategory->slug]) }}"
                                                    class="nav-link">{{ $parentCategory->name }}</a>
                    ...
                    <div class="top-menu-menu">
                        ...
                        <ul class="navbar-nav">
                                ...
                                <ul class="level-one">
                                    @foreach ($parentCategories as $parentCategory)
                                        <li class="position-relative"><a
                                                href="{{ route('home.categories.show', ['category' => $parentCategory->slug]) }}">{{ $parentCategory->name }}<i
                            ...
                            <li class="nav-item"><a href="{{ route('home.index') }}"
                                    class="nav-link border-animate fromRight"><i class="bi bi-house"></i> خانه </a>
                            </li>
                            <li class="nav-item"><a href="{{ route('home.shop') }}"
                                    class="nav-link border-animate fromRight"><i class="bi bi-cart-plus"></i> فروشگاه
                                </a>
                            </li>
                            <li class="nav-item"><a href="{{ route('home.blog.index') }}"
                                    class="nav-link border-animate fromRight"><i class="bi bi-book"></i> مقالات </a>
                            </li>

                            <li class="nav-item"><a href="{{ route('home.about-us') }}"
                                    class="nav-link border-animate fromRight"><i class="bi bi-people"></i> درباره ما
                                </a>
                            </li>
                            <li class="nav-item"><a href="{{ route('home.contact-us') }}"
                                    class="nav-link border-animate fromRight"><i class="bi bi-telephone-inbound"></i>
                                    تماس با ما </a></li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <ul style="width: 207px !important;margin-right: 219px !important;padding-top: 14px;">
                                        ...
                                        <li><a href="{{ route('home.orders.users_profile.index') }}" target="_blank"
                                                style="font-weight: bold"><i class="fa-solid fa-cart-shopping"
                                                    style="margin-left: 10px;margin-top: 3px;"></i>سفارش </a></li>

                                        <li><a href="{{ route('home.wishlist.users_profile.index') }}" target="_blank"
                                                style="font-weight: bold"><i class="fa-solid fa-heart"
                                                    style="margin-left: 10px;margin-top: 3px;"></i>علاقه مندی ها</a></li>
                                        <li><a href="{{ route('home.comments.users_profile.index') }}" target="_blank"
                                                style="font-weight: bold"><i class="fa-solid fa-message"
                                                    style="margin-left: 10px;margin-top: 3px;"></i>نظرات ثبت شده</a></li>
                                        <li><a href="{{ route('logout') }}" target="_blank" style="font-weight: bold"><i
                                                    class="fa-solid fa-right-from-bracket"
                                                    style="margin-left: 10px;margin-top: 3px;"></i>خروج از حساب کاربری</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
    ...
    <div class="mobile-footer d-lg-none d-table justify-content-center shadow-box bg-white position-fixed bottom-0 p-2 w-100"
        ...
        <ul class="d-table-row">
            ...
            <li class="d-table-cell"><a href="{{ route('home.wishlist.users_profile.index') }}"
            ...
            @auth
                <li class="d-table-cell"><a href="{{ route('home.users_profile.index') }}"
                        class="mf-link nav-link text-center">
            ...
            @else
                <li class="d-table-cell"><a href="#loginModal" class="mf-link nav-link text-center"
                        data-bs-toggle="modal" data-bs-target="#loginModal" role="button">
