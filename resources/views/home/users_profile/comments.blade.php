                                                    ...
                                                    <div
                                                        ...
                                                        <div class="review-name d-flex align-items-center">
                                                            ...
                                                            <a class="mr-1"
                                                                ...
                                                                style="color:#ff3535;">
                                                                <img src="{{ asset(env('PRODUCT_IMAGES_UPLOAD_PATH') . $comment->product->primary_image) }}"
                                                                    alt="" width="150px">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <div class="d-flex align-items-center">
                                                                        <div
                                                                            ...
                                                                            <img src="{{ $comment->user->avatar == null ? asset('assets/image/user-profile.png') : $comment->user->avatar }}"
                                                                                alt=""
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h6 class="text-muted font-14">
                                                                                {{ $comment->user->name == null ? 'کاربر گرامی' : $comment->user->name }}
                                                                            </h6>
                                                                            <h6 class="text-muted font-14 ms-2">
                                                                                {{ verta($comment->created_at)->format('d') }}
                                                                                {{ verta($comment->created_at)->formatWord('F') }}
                                                                                {{ verta($comment->created_at)->format('Y') }}
                                                                            </h6>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="my-paginate pb-3">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center">
                                                ...
                                                <li class="page-item"><a class="page-link rounded-3" href="#">3</a>
                                                </li>
