                                        ...
                                        <div class="col-xl-3 col-6 dashboard-cart-col">
                                            <div class="dashboard-cart shadow-box">
                                                <div class="dashboard-cart-title"><i class="bi bi-bag-check"></i> سفارشات تکمیل
                                                    شده</div>
                                                <div class="dashboard-cart-footer" style="background: #0476D0;">
                                                    {{ $orders->where('payment_stage', 'completed')->count() }}</div>
                                            </div>
                                    </a>
                                </div>
                                <div class="col-xl-3 col-6 dashboard-cart-col">
                                    <div class="dashboard-cart shadow-box">
                                        <div class="dashboard-cart-title"><i class="bi bi-activity"></i> سفارشات در
                                            انتظار بررسی</div>
                                        <div class="dashboard-cart-footer" style="background: #F6A21E;">
                                            {{ $orders->where('payment_stage', 'waiting')->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-6 dashboard-cart-col">
                                    <div class="dashboard-cart shadow-box">
                                        <div class="dashboard-cart-title"><i class="bi bi-x-octagon"></i>سفارشات جاری</div>
                                        <div class="dashboard-cart-footer" style="background: #0db47f;">
                                            {{ $orders->where('payment_stage', 'inprogress')->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-6 dashboard-cart-col">
                                    <div class="dashboard-cart shadow-box">
                                        ...
                                        <div class="dashboard-cart-footer" style="background: #BA0F30;">
                                            {{ $orders->where('payment_stage', 'canceled')->count() }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <p class="fw-bold mt-2">
                                                                {{ verta(auth()->user()->created_at)->format('d') }}
                                                                {{ verta(auth()->user()->created_at)->formatWord('F') }}
                                                                {{ verta(auth()->user()->created_at)->format('Y') }}</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                ...
                                                                <div>
                                                                    <address>
                                                                        ...
                                                                        <p class="address_p">
                                                                            {{ $address->address }}
                                                                            <br>
                                                                            <span class="address_p"> استان :
                                                                                {{ province_name($address->province_id) }}
                                                                            </span>
                                                                            <span> شهر : {{ city_name($address->city_id) }}
                                                                            </span>
                                                                        </p>
                                                                        <p class="address_p">
                                                                            کدپستی :
                                                                    ...
                                                                    <a href="#" class="btn-main btn-main-primary"
                                                                        data-bs-toggle="collapse"
                                                                        data-bs-target="#collapseEdit-{{ $address->id }}"
                                                                    ...
                                                                    <div class="collapse" id="collapseEdit-{{ $address->id }}"
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="tax-select col-lg-6 col-md-6">
                                                                                    ...
                                                                                    <select class="form-control"
                                                                                        class="email s-email s-wid city-select"
                                                                                        name="city_id">
                                        ...
                                        <div class="ui-box-item ui-box-white">
                                            <div class="ui-box-item-title">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <a class="btn-main btn-main-primary"
                                                        href="{{ route('home.wishlist.users_profile.index') }}">مشاهده همه <i
                                                                ...
                                                                <a
                                                                    ...
                                                                    <div class="product-row-desc">
                                                                                    ...
                                                                                    @if ($item->product->quantity_check)
                                                                                        @if ($item->product->sale_check)
                                                                                            <div
                                                                                                ...
                                                                                                <div>
                                                                                                    <span
                                                                                                        class="fw-bold font-18 def-color">
                                                                        ...
                                                                        <div class="product-row-icon">
                                                                            <a
                                                                                href="{{ route('home.wishlist.remove', ['product' => $item->product->id]) }}"><i
                                                                ...
                                                                <a href="order-detail.html">
                                                                    ...
                                                                    <div class="order-item-product-list">
                                                                        <div class="order-item-product-list-item">
                                                                            <img src="img/product/product-image1.jpg"
                                                                                alt="" class="img-thumbnail"
                                                                                width="70" height="70">
                                                                        </div>
                                                                        <div class="order-item-product-list-item">
                                                                            <img src="img/product/product-image3.jpg"
                                                                                alt="" class="img-thumbnail"
                                                                                width="70" height="70">
                                                                        </div>
                                                                        <div class="order-item-product-list-item">
                                                                            <img src="img/product/product-image4.jpg"
                                                                                alt="" class="img-thumbnail"
                                                                                width="70" height="70">
                                                                        </div>
                                                                        <div class="order-item-product-list-item">
                                                                            <img src="img/product/product-image5.jpg"
                                                                                alt="" class="img-thumbnail"
                                                                                width="70" height="70">
                                                                        </div>
                                                                        <div class="order-item-product-list-item">
                                                                            <img src="img/product/product-image6.jpg"
                                                                                alt="" class="img-thumbnail"
                                                                                width="70" height="70">
                                                                        </div>
                                                                    </div>
