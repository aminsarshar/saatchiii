<div class="card">
    <div class="card-header d-flex" style="justify-content: space-between;align-items: center;">
        ...
        <div class="input-group w-50">
            <input type="text" class="form-control" placeholder="جستجوی سفارش" aria-label="Amount" wire:model="search">
                ...
                <tbody>
                    @foreach ($orders as $index => $order)
                        <tr>
                            ...
                            <td wire:click="ChangePaymentStage({{ $order->id }})" style="cursor: pointer"
