                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="color:  rgb(40, 208, 148);" class="btn btn-sm btn-outline-success mr-1"
                                        wire:click="restoreUser({{ $user->id }})" class="btn btn-success">بازگردانی
                                        <i class="fa fa-pencil font-medium-3 mr-2"></i></a>
                                </td>

                                <td>
                                    <a style="color: #fc0000" class="btn btn-sm btn-outline-danger mr-1"
                                        wire:click="forceDeleteUser({{ $user->id }})" data-original-title=""
