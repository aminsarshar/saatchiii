...
@section('script')
    ...
    // وقتی فیلتر تغییر کرد صفحه برگرده اول
    params.delete('page');
...
@section('content')
                                    ...
                                    <div class="title">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a class="btn border-0" data-bs-toggle="collapse"
                                                href="#collapseItemBoxSearch" role="button" aria-expanded="false">
                                                    ...
                                                    <div class="foot d-flex justify-content-between align-items-center">
                                                        <form action="{{ route('home.cart.add') }}" method="POST">
                                                            ...
                                                            @if ($product->quantity_check)
                                                                ...
                                                                <form action="{{ route('home.cart.add') }}"
                                                                    method="POST">
                                                                    <input type="hidden" name="product_id"
                                                                        value="{{ $product->id }}">
                                                                    @csrf
                                                            ...
                                                            @else
                                                                <div class="not-in-stock">
                                                                    <p class="text-white" style="padding-right:56px">
                                                                        ناموجود</p>
                                                                </div>
                                                            @endif
                                                        </form>
                            ...
                            <div class="my-paginate my-4">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item active"><a class="page-link rounded-3" href="#">1</a>
                                        </li>
    ...
    @else
        {{-- <div class="content">
            <div class="alert alert-danger">وجود ندارد</div>
        </div> --}}

        <div class="content">
            <div class="container-fluid">
                <div class="alert alert-danger">محصولی با این نام وجود ندارد</div>
            </div>
        </div>
    @endif
@endsection
